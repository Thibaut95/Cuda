...
ImageCustomEvent::ImageCustomEvent(Animable_I<uchar4>* ptrAnimable,ColorRGB_01 colorTexte)
    ...
    {
    // Tools
    heatTransfert=(HeatTransfert*)ptrAnimable;
    listener();
    }
...
void ImageCustomEvent::listener(void)
    {
    this->ptrKeyListener = new SimpleKeyListener(heatTransfert);
    this->ptrMouseListener = new SimpleMouseListener(heatTransfert);
